class FarewellGoodsCertificate
  ...
  belongs_to :user, :class_name => "User", :inverse_of => :farewell_goods_certificates

  field :doc_no,                      type: String

  field :doc_date,                    type: Date,   default: Date.today
  field :applicant_name,              type: String
  field :applicant_birthplace,        type: String
  field :applicant_birthdate,         type: String
  field :applicant_passport,          type: String
  field :applicant_address_indonesia, type: String
  ...
  private
    ...
    def assign_doc_no
      ...
      self.doc_no = seq_no + "/KONS/" + seq_month + "/" + seq_year
    end
