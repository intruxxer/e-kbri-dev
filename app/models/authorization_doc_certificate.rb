class AuthorizationDocCertificate
  ...
  belongs_to :user, :class_name => "User", :inverse_of => :authorization_doc_certificate

  field :doc_no,                      type: String
  field :doc_date,                    type: Date,   default: Date.today

  field :doc_applicant,               type: String
  field :doc_applicant_passport,      type: String
  ...
  def assign_doc_no
    ...
    self.doc_no = seq_no + "/PA/" + seq_month + "/" + seq_year
  end
