class Splp
  ...
  before_create :assign_ref_id, :set_capitalized #:set_vipacounter, :assign_passport_fee
  #after_update :assign_passport_fee
  belongs_to :user, :class_name => "User", :inverse_of => :splp
  ...
  field :placeIssued,            type: String, default: 'Seoul'
  ...
  field :printed_date,          type: Date,   default: Date.today
  field :pickup_office,         type: String, default: 'seoul'
  field :pickup_date,           type: Date,   default: Date.today
