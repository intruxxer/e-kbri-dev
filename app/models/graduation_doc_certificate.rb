class GraduationDocCertificate
  ...
  belongs_to :user, :class_name => "User", :inverse_of => :graduation_doc_certificates

  field :doc_no,                      type: String
  field :doc_date,                    type: Date,   default: Date.today

  field :doc_applicant,               type: String
  field :doc_university,              type: String
  ...
  def assign_doc_no
    ...
    self.doc_no = seq_no + "/LD/" + seq_month + "/" + seq_year
  end
